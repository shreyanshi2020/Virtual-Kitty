...
function preload()
{
  ...
  happyDog = loadImage("Kitty.png");

  normalDog = loadImage("Kitty.png");

  sleepyDog = loadImage("sleeping (2).png");

  bathroom = loadImage("bathing2.png");

  living = loadImage("playing3.png")
}
